...
class EstudiantesControllerTest < ActionController::TestCase
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post :create, estudiante: { email: @estudiante.email, nombre: @estudiante.nombre, password: @estudiante.password }
    end
  ...
  test "should update estudiante" do
    patch :update, id: @estudiante, estudiante: { email: @estudiante.email, nombre: @estudiante.nombre, password: @estudiante.password }
    assert_redirected_to estudiante_path(assigns(:estudiante))
  end
